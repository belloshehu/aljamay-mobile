...
interface AdminProductDetailHeaderProps {
  product: ProductType
}
const AdminProductDetailHeader: FC<AdminProductDetailHeaderProps> = (
  props: AdminProductDetailHeaderProps,
) => {
  const {
    product: { name, image },
  } = props
...
export default AdminProductDetailHeader
